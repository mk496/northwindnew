		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "northwindnew",
									"targetURL": "#northwindnewnorthwindnew-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"northwindnewnorthwindnew-display": {
								"semanticObject": "northwindnewnorthwindnew",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=northwindnew.northwindnew",
									"url": sap.ui.require.toUrl("northwindnew/northwindnew")
								}
							}
						}
					}
